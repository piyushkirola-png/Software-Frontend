          ...
          <Reveal>
            <div className="bg-white rounded-2xl shadow-card p-8 lg:p-10 text-center">
              ...
              <p className="text-sm text-muted mb-8">
                Your order <b className="text-navy font-mono">{orderNumber}</b>{" "}
                has been confirmed.
              </p>
              ...
              <div className="grid grid-cols-3 gap-3 my-8">
                <div className="p-4 rounded-2xl bg-soft border border-gray-100">
                  ...
                  <div className="text-xs font-bold text-navy">Email Sent</div>
                ...
                <div className="p-4 rounded-2xl bg-soft border border-gray-100">
                  ...
                  <div className="text-xs font-bold text-navy">GST Invoice</div>
                  <div className="text-[10px] text-muted mt-1">
                    Download anytime
                  </div>
                </div>
