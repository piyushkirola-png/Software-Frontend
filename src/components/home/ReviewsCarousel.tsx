            ...
            <Reveal delay={100}>
              <div className="grid md:grid-cols-3 gap-5">
                {list.slice(start, start + visible).map((r) => (
                  <div
                    key={r.id}
                    className="bg-white border border-gray-100 rounded-2xl p-6 hover:shadow-cardHover transition-shadow"
                  >
            ...
            {list.length > visible && (
              <div className="flex items-center justify-center gap-4 mt-10">
                <button
                  ...
                  disabled={start === 0}
                  className="w-10 h-10 rounded-full border border-gray-200 bg-white flex items-center justify-center hover:border-brand disabled:opacity-40"
                >
                  <ChevronLeft size={18} />
                </button>
